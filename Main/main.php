...
@media only screen and (max-width: 300px) {
  .text {font-size: 11px}
	 ...
	 <script type="text/javascript">
		 ...
		 <div id="gradient"></div>
	         <header>
		       <h1 class = "neon" data-text="Movie Database"><a href="main.php">Movie Database</a></h1>
             </header></br>
			 <div class="tab2">
			 <ul>
			   <li><a>MOVIES</a>
		 	...
		 	<form class="srch" method="POST" action="srch.php">
				<input name="search" type="text" id="searchBar" placeHolder="" value="Search a movie..." onMouseDown="active()"; />
...
<div class="mySlides fade">
  ...
  <img src="av.jpg" style="margin: 0px 20px">
  <div class="text">Avengers</div>
</div>

<div class="mySlides fade">
  
  <img src="ven.jpg" style="height:20% width:100%">
  <div class="text">Venom</div>
</div>
<div class="mySlides fade">
  
  <img src="tomb.jpg" >
  <div class="text">Tomb Raider</div>
</div>
<div class="mySlides fade">
  
  <img src="won.jpg" >
  <div class="text">Wonder women</div>
</div>
<div class="mySlides fade">
  
  <img src="kfg.jpg" >
  <div class="text">KFG</div>
</div>
</div>
<br>
